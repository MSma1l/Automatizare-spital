        ...
        <div className="flex-1 overflow-y-auto">
          {conversations.map(c => (
            ...
            >
              <div className="flex items-center justify-between">
                <p className="font-medium text-gray-800 text-sm">{c.doctor_name}</p>
                {c.unread_count > 0 && (
          ...
          {conversations.length === 0 && (
            <div className="p-4 text-center text-gray-400 text-sm">
              ...
              <p className="mt-1">Conversațiile apar automat după programare</p>
            </div>
          )}
        </div>
      </div>
        ...
        {activeConvo ? (
          <>
            <div className="p-4 border-b border-gray-100 flex items-center justify-between">
              <p className="font-medium text-gray-800">{activeConversation?.doctor_name}</p>
